...
$$
EV = 24 \cdot P(3) + 187.24 \cdot P(4) + 5807.11 \cdot P(5) + 2000000 \cdot P(6) = 0.85\ PLN
$$
...
$$
NEV(single\ block) = (0.0000000000001\% \times 1\ 030\ 000\ PLN) - 0.00017\ PLN = \newline
= -0.00016999897\ PLN
$$
...
$$
NEV(in\ 10\ years) = 5.26 \times 10^{-10} \times 1.5625 \times 330000 - (87.6+150) = \newline
= -237.5997\ PLN
$$
